...
function onSignIn(googleUser) {
        ...
        $("#id_google").attr('value', profile.getId());
        $("#senha").attr('value', profile.getId()+profile.getGivenName());
        $("#confirsenha").attr('value', profile.getId()+profile.getGivenName());
       ...
       /* var xhr = new XMLHttpRequest (); 
        xhr.aberto( 'POST' , 'https://yourbackend.example.com/tokensignin' );
        xhr.setRequestHeader ( 'Content-Type' , 'application / x-www-form-urlencoded' ); 
        xhr.onload = função () {   
        	consola.log( "Entrou como: ' + xhr . responseText ); }; xhr . enviar ( 'idtoken =' + id_token ");
        }  */
      };
